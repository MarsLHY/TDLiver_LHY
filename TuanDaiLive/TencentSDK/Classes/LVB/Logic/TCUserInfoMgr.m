...
static TCUserInfoMgr *_shareInstance = nil;
...
+ (instancetype)sharedInstance;
{
    ...
    dispatch_once(&predicate, ^{
        _shareInstance = [[TCUserInfoMgr alloc] init];
    });
